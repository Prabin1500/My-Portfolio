  ...
  return (
    <div className='w-11/12 text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <motion.h3 
            ...
            className='flex items-end gap-2 text-2xl md:text-xl mb-3 font-Ovo'>
            Hi! I am Prabin 
        ...
        <motion.p 
            ...
            className='max-w-2xl mx-auto font-Ovo text-xl'>
            Worked collaboratively with other students in group projects as well as worked on individual coding challanges. 
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            <motion.a 
                ...
                whileInView={{y: 0, opacity: 1}}
                transition={{duration:0.6, delay: 1}}
                href='../../asstes/resume-prabin.pdf' download 
